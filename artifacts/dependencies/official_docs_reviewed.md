...
- yt-dlp README: dependencies, release channels, Python support, `yt-dlp[default]`, ffmpeg and EJS requirements. https://github.com/yt-dlp/yt-dlp
- yt-dlp EJS wiki: Deno recommended, minimum Deno 2.0.0, `yt-dlp-ejs`, `--js-runtimes`. https://github.com/yt-dlp/yt-dlp/wiki/EJS
...
- uv pip docs: pip/venv replacement interface and compatibility caveats. https://docs.astral.sh/uv/pip/
- PycURL docs/PyPI: Windows wheels/native build impact. https://pycurl.io/docs/latest/install.html
- Pillow docs/PyPI: current wheels and Python support. https://pillow.readthedocs.io/
- pystray docs: tray icon API surface. https://pystray.readthedocs.io/
