...
try {
    ...
    if ($SkipPythonPackage -or $SkipTwineCheck) {
        Add-BuildWarning "legacy-skip-package-switches" "-SkipPythonPackage and -SkipTwineCheck are accepted for compatibility but the canonical script does not build Python distributions by default."
    }
